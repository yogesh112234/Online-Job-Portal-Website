<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="onlinejobportal3.admin.NewJob" %>
        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control" placeholder="Ex. Web Developer" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. MCA, BCA" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtNoOFPost" style="font-weight: 600">Exprience Required</label>
                    <asp:TextBox ID="txtExprience" runat="server" CssClass="form-control" placeholder="Ex: 2Years, 3Years" required>
                    </asp:TextBox>
                </div>
            </div>
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtSpecilization" style="font-weight: 600">Specilization Required</label>
                    <asp:TextBox ID="txtSpecilization" runat="server" CssClass="form-control" placeholder="Enter Specilization"
                        TextMode="MultiLine" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
