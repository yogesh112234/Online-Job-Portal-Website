...
namespace onlinejobportal3.admin
{
    public partial class NewJob : System.Web.UI.Page
    {
                 ...
                 while(sdr.Read())
                    {
                        ...
                        txtExprience.Text = sdr["Experience"].ToString();
                        txtSpecilization.Text = sdr["Specialization"].ToString();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(Request.QueryString["id"]!= null)
                {
                    ...
                    cmd.Parameters.AddWithValue("@Experience", txtExprience.Text.Trim());
                    cmd.Parameters.AddWithValue("@Specialization", txtSpecilization.Text.Trim());
        ...
        private void Clear()
        {
            ...
            txtExprience.Text = string.Empty;
